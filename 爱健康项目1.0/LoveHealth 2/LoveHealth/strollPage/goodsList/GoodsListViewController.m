...
- (void)createCollectView{
    ...
    [self.collectView registerClass:[QualityGoodsCollectionViewCell class] forCellWithReuseIdentifier:@"cell2"];
    [self.collectView registerClass:[GoodShopCollectionViewCell class] forCellWithReuseIdentifier:@"cell3"];
