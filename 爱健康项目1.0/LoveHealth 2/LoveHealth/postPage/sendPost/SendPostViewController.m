...
-(void)createPart{
    ...
    self.contentView = [[UITextView alloc]initWithFrame:CGRectMake(15, 185, 290, 305)];
    ...
    self.addpicLabel = [[UILabel alloc]initWithFrame:CGRectMake(243, 415, 60, 18)];
    ...
    self.addpicBtn = [[UIButton alloc]initWithFrame:CGRectMake(243, 432, 50, 50)];
...
-(void)textViewDidBeginEditing:(UITextView *)textView{
    self.contentView.frame = CGRectMake(15, 180, 290, 130);
}
-(void)textViewDidEndEditing:(UITextView *)textView{
    self.contentView.frame = CGRectMake(15, 180, 290, 305);
}
